...
<div class="wrap">
  ...
  <?php
		if ($actualizacion) echo '<div id="message" class="updated fade"><p><strong>' . __('Options saved.', 'xml_video_sitemap') . '</strong></p></div>' . PHP_EOL;
		$tab = 1;
  ...
  <form method="post" action="">
    <div class="cabecera"> <a href="<?php echo $xml_video_sitemap['plugin_url']; ?>" title="<?php echo $xml_video_sitemap['plugin']; ?>" target="_blank"><span class="imagen"></span></a> </div>
